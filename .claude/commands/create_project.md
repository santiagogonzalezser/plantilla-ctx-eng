...
## Where to create it
- Create a new directory at: `/projects/<slug-from-name-or-prompt>/`
...
2. **Scaffold** the project in `/projects/<slug>/` using standard tooling for the detected stack.
...
4. Create a short `/projects/<slug>/README.md` including:
...
5. Create an empty `/projects/<slug>/features/` folder (ready for `create_initial` if needed).
